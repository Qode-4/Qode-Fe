...
export type CreateStorageItemBody =
  | {
      type: 'github_repo';
      title: string;
      url: string;
...
export type UpdateStorageItemBody = { title: string };

export type StorageItemListResponse = { ok: true; data: StorageItem[] };
export type StorageItemResponse = { ok: true; data: StorageItem };
