  ...
  return (
    <OverlayModal open={open} onClose={onClose} title="방장이 나가기 전에 선택해주세요" size="sm">
      <p className="text-label leading-[1.6] text-fg-default">
        방장이 채팅방을 나가려면 채팅방을 삭제하거나, 다른 참여자에게 방장을 넘겨야 해요.
      </p>
      ...
      <div className="mt-5 flex flex-col gap-2">
        ...
        >
          <span className="text-label font-semibold text-fg-default">방장 넘기기</span>
          <span className="text-caption text-fg-muted">
            다른 참여자에게 방장을 넘기고 채팅방에서 나가요. 채팅방과 대화는 그대로 남아요.
          </span>
        </button>
        ...
        >
          ...
          <span className="text-caption text-fg-muted">
            채팅방과 모든 대화가 삭제되고, 참여자 전원이 더 이상 볼 수 없어요.
          </span>
        </button>
      </div>
