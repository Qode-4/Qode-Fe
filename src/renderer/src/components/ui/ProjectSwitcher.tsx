...
export const ProjectSwitcher = ({
  ...
  return (
    <div ref={containerRef} className={['relative min-w-0', className ?? ''].join(' ')}>
      ...
      {open ? (
        <div className="absolute left-0 top-[calc(100%+8px)] z-20 w-[220px] overflow-hidden rounded-[18px] border border-line bg-surface py-2 shadow-none">
          <div
            role="listbox"
                  ...
                  >
                    <button
                      ...
                      className={[
                        ...
                        isSelected ? 'text-text-base' : 'text-text-base'
                      ].join(' ')}
                      onClick={() => {
                        setOpen(false);
