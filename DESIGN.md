...
- 상태: **In sync** (2026-09-26) — 실제 구현과 코드가 이 문서와 정합한 상태로 유지된다. 이후 컴포넌트를 추가하거나 스타일을 손볼 때 이 기준서를 먼저 갱신하고 코드를 맞춘다.
...
상황별 톤·용어집·전후 예시는 [`docs/copy.md`](docs/copy.md) 가 기준이다(해요체, 말줄임표 `…`).
